...
do
	...
	for agentNum in 10 15 20 25 30 40  50 60 70 80 90 #100
	...
	do	
		...
		#do
			...
			#		do
					...
					python3 core.py --txs 20000 --netsize $agentNum --printing False --dltmode dht --seed $seednum --map $mapName --consensus simple
